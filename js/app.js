...
let favorite4 = {
    name: 'Milk & Honey',
    category: 'spa',  // Try: fitness, services, shopping
    rating: 4,
    notes: 'Great massage and facial services. Clean and relaxing environment. On the pricier side but worth it.'
};
...
let favorite5 = {
    ...
    category: 'food',
    rating: 5,
    notes: 'One of my favorite restuarants in Fort Worth. Great for brunch, lunch, or dinner. The food is always fresh and delicious, and the atmosphere is cozy and inviting.'
};
